...
class Event_manage_model extends MY_Model {
	...
	{
		$sql = @"SELECT a.*,b.event_title FROM mod_register a LEFT JOIN mod_event b ON a.event_id = b.event_id $filter ORDER BY a.drop_date DESC LIMIT $dataStart, $dataLen";
	...
	{
		$sql = @"SELECT a.regi_id, a.event_id, a.account, a.drop_date, a.regi_type, b.name,b.contact_mail, c.event_title,b.contact_tel FROM mod_register a, mod_resume b, mod_event c WHERE a.event_id=? AND a.account=b.account AND a.event_id=c.event_id";
		$para = array($event_id);
