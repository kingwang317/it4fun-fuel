...
class Edm_manage extends Fuel_base_controller {
	...
	public $module_name = 'edm manage';
	public $module_uri = 'fuel/edm/lists';
	...
	function lists($dataStart=0)
	{
		...
		$this->fuel->admin->render('_admin/edm_lists_view', $vars, 'edm');
	...
	function create()
	{
		...
		$vars['form_action'] 	= base_url().'fuel/edm/do_create';
		...
		$this->fuel->admin->render('_admin/edm_create_view', $vars, 'edm');
	}
	...
	function edit($edm_id)
	{
		...
		$this->fuel->admin->render('_admin/edm_edit_view', $vars, 'edm');
	}
	...
	function edm_log_list($edm_id, $dataStart=0)
	{
		...
		if($edm_id)
		{
			...
			$this->fuel->admin->render('_admin/edm_log_view', $vars, 'edm');
		}
		else
		{
