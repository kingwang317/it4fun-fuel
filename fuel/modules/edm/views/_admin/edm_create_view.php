...
<script type="text/javascript">
	...
	$(document).ready(function($) {
       ...
       var config =
		...
		$( "#edm_send_time" ).datepicker();
		$( "#edm_send_time" ).datepicker( "option", "dateFormat", "yy-mm-dd" );
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td>電子報內容</td>
					<td>
						<textarea name="edm_desc" id="edm_desc"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align:right">
						<button class="btn btn-small btn-primary" type="button" id="sendbtn" data-href="<?php echo $send_url;?>">送出信件</button>
						<button class="btn btn-small btn-primary" type="button" id="addbtn" data-href="<?php echo $submit_url?>">儲存信件</button>
