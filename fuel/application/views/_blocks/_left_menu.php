...
<div class="leftbox">
  <div class="box">
      ...
      <ul>
          ...
          <li><a href="<?php echo site_url().'notices' ?>">通知</a>
            <?php if (isset($notice_count) && $notice_count > 0): ?>
              <div class="circle"><?php echo $notice_count ?></div>
            <?php endif ?>            
          </li>
